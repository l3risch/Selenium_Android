...
public class Connection {
    ...
    public void buildConnection()
    {
        ...
        System.setProperty("webdriver.gecko.driver", "app/src/main/res/resources/" +
    ...
    public static void measureConnection(FirefoxDriver driver) throws IOException
    {
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(".app/output" +
                "/StatisticalData.txt", false));
